...
const Profile = () => {
  ...
  const renderSection = () => {
    switch (activeSection) {
      case "description":
        return (
          <Description control={control} handleDataChange={handleDataChange} />
        );
      case "location":
        return (
          <Map
      ...
      case "portfolio":
        return (
          <Portfolio
            image1={profileData?.gigImage1}
            image2={profileData?.gigImage2}
            image3={profileData?.gigImage3}
          />
        );
      default:
        return null;
  ...
  return (
    <div className="w-full h-full">
      <h1 className="text-[2vw] text-yellow-600 underline mt-vw font-medium text-center w-full">
      ...
      <main className="flex p-vvw mt-2vw w-full">
        ...
        <ToastContainer />
        <form
          className="w-full h-[30vw] m-vw rounded-md shadow-md border-[1px] "
        ...
        >
            ...
            <p
              ...
              className={`text-[1vw] ${
                activeSection === "description"
                  ...
                  : ""
              } cursor-pointer ml-vw font-medium`}
            >
              Description
            </p>
            <p
          ...
          <input
            type="submit"
            value="Submit"
            className="bg-yellow-600 hover:bg-yellow-500 p-[0.5vw] text-vw ml-[1vw] text-white rounded-md shadow-lg cursor-pointer"
          />
        </form>
      </main>
    </div>
